namespace compesa
{
    public static class Configuration
    {
        ...
        public static string SearchUser(string userName)
        {
            ...
            return $"SELECT * FROM usuario WHERE Nome = '{userName}';";
        }
